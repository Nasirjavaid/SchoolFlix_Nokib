...
class AppTheme {
  ...
  static const Color background = Color(0xFFFFCF00);
  static const Color textBlue = Color(0xFF016BFF);
  ...
  static Color pieChartBackgroundColor1 = Colors.blue[300];
  ...
  static List<Color> pieCahrtColourList3 =[pieChart3Color1,pieChart3Color2,pieChart3Color3];
...
//By me
  static final TextStyle _lightScreenTextStyleDisplay1 =
      TextStyle(fontSize: 34.0, color: _lightOnPrimaryColor);
  static final TextStyle _lightScreenTextStyleDisplay2 =
      TextStyle(fontSize: 45.0, color: _lightOnPrimaryColor);
  static final TextStyle _lightScreenTextStyleDisplay3 =
      TextStyle(fontSize: 56.0, color: _lightOnPrimaryColor);
  static final TextStyle _lightScreenTextStyleDisplay4 =
      TextStyle(fontSize: 112.0, color: _lightOnPrimaryColor);
  static final TextStyle _lightScreenTextStyleHeadline =
      TextStyle(fontSize: 24.0, color: _lightOnPrimaryColor);
  static final TextStyle _lightScreenTextStyleTitle =
      TextStyle(fontSize: 20.0, color: _lightOnPrimaryColor);
  static final TextStyle _lightScreenTextStyleSubhead =
      TextStyle(fontSize: 16.0, color: _lightOnPrimaryColor);
  static final TextStyle _lightScreenTextStyleBody1 =
      TextStyle(fontSize: 11.0, color: Colors.black54);
  static final TextStyle _lightScreenTextStyleBody2 =
      TextStyle(fontSize: 14.0, color: _lightOnPrimaryColor);
  static final TextStyle _lightScreenTextStyleCaption =
      TextStyle(fontSize: 12.0, color: _lightOnPrimaryColor);
  static final TextStyle _lightScreenTextStyleButton =
      TextStyle(fontSize: 14.0, color: _lightOnPrimaryColor);
  static final TextStyle _lightScreenTextStyleSubTitle =
      TextStyle(fontSize: 14.0, color: _lightOnPrimaryColor);
  static final TextStyle _lightScreenTextStyleSubOverLine =
      TextStyle(fontSize: 10.0, color: _lightOnPrimaryColor);
//
